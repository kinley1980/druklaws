...
class CSORulesViewController: UITableViewController, UISearchBarDelegate {
    @IBOutlet weak var searchBar: UISearchBar!
    
    private var rules = ["Civil Society Org Rules and Regulations","THE COOPERATIVES RULES AND REGULATIONS OF BHUTAN 2010 (Dzongkha)","THE COOPERATIVES RULES AND REGULATIONS OF BHUTAN 2010 (English)"]
