...
class MunicipalityViewController: UITableViewController, UISearchBarDelegate {

    @IBOutlet weak var searchBar: UISearchBar!
    
    private var rules = ["Thimphu Municipal Development Control Regulations 2004 English","Thimphu Thromde Development Control Regulation 2016","Thromde Rules 2011"]
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        let pdfVC = segue.destination as! pdfmunicipalityViewController
